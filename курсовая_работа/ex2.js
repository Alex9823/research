...
var items = [
    ...
    ["stimuli1", "AcceptabilityJudgment", {s: "лебедь плывет"}],
    ["stimuli2", "AcceptabilityJudgment", {s: "яблоко падает"}],  
    ["stimuli2", "AcceptabilityJudgment", {s: "оценка падает"}],
    ["stimuli3", "AcceptabilityJudgment", {s: "бросает рюкзак с балкона"}],
    ["stimuli3", "AcceptabilityJudgment", {s: "бросает сумку на землю"}],
    ["stimuli4", "AcceptabilityJudgment", {s: "кидает вещи на стол"}],
    ["stimuli4", "AcceptabilityJudgment", {s: "кидает камни в птицу"}],
    ["stimuli5", "AcceptabilityJudgment", {s: "река течет"}],
    ["stimuli5", "AcceptabilityJudgment", {s: "жизнь течет"}],
    ["stimuli6", "AcceptabilityJudgment", {s: "боинг рухнет"}],
    ["stimuli6", "AcceptabilityJudgment", {s: "ящик рухнет"}],	
    ["stimuli7", "AcceptabilityJudgment", {s: "планета вращается вокруг солнца"}],
    ["stimuli7", "AcceptabilityJudgment", {s: "фигурист вращается на льду"}],
    ["stimuli8", "AcceptabilityJudgment", {s: "человек шатается от боли"}],
    ["stimuli8", "AcceptabilityJudgment", {s: "пьяница шатается по кабакам"}],
    ["stimuli9", "AcceptabilityJudgment", {s: "веревка болтается на крючке"}],
    ["stimuli9", "AcceptabilityJudgment", {s: "повязка болтается на лице"}],
    ["stimuli10", "AcceptabilityJudgment", {s: "птенец выпадет из гнезда"}],
    ["stimuli10", "AcceptabilityJudgment", {s: "зубы выпадут от удара"}],
    ["stimuli11", "AcceptabilityJudgment", {s: "пламя колеблется"}],
    ["stimuli11", "AcceptabilityJudgment", {s: "ученик колеблется"}],
    ["stimuli12", "AcceptabilityJudgment", {s: "дитя тянется за пищей"}],
    ["stimuli12", "AcceptabilityJudgment", {s: "лошадь тянется за сеном"}],
    ["stimuli13", "AcceptabilityJudgment", {s: "толкает перед собой телегу"}],
    ["stimuli13", "AcceptabilityJudgment", {s: "толкает Васю в бок"}],
    ["stimuli14", "AcceptabilityJudgment", {s: "люстра висит"}],
    ["stimuli14", "AcceptabilityJudgment", {s: "долги висят"}],
    ["stimuli15", "AcceptabilityJudgment", {s: "змея ползет по траве"}],
    ["stimuli15", "AcceptabilityJudgment", {s: "паук ползет по паутине"}],
    ["stimuli16", "AcceptabilityJudgment", {s: "такси встанет"}],
    ["stimuli16", "AcceptabilityJudgment", {s: "человек встанет"}],
    ["stimuli17", "AcceptabilityJudgment", {s: "ищет работу на сайте"}],
    ["stimuli17", "AcceptabilityJudgment", {s: "ищет счастья заграницей"}],
    ["stimuli18", "AcceptabilityJudgment", {s: "найдет ключи в кармане"}],
    ["stimuli18", "AcceptabilityJudgment", {s: "найдет носок на кровати"}],
    ["stimuli19", "AcceptabilityJudgment", {s: "кольцо соскочит с пальца"}],
    ["stimuli19", "AcceptabilityJudgment", {s: "мальчик соскочит с подножки"}],
    ["stimuli20", "AcceptabilityJudgment", {s: "шляпа слетит с головы"}],
    ["stimuli20", "AcceptabilityJudgment", {s: "краски слетят с лица"}],
    ["stimuli21", "AcceptabilityJudgment", {s: "поставит сковородку на плиту"}],
    ["stimuli21", "AcceptabilityJudgment", {s: "поставит пирог в думовку"}],
    ["stimuli22", "AcceptabilityJudgment", {s: "режет огурцы на доске"}],
    ["stimuli22", "AcceptabilityJudgment", {s: "режет баранов на ужин"}],
    ["stimuli23", "AcceptabilityJudgment", {s: "достанет ручку из сумки"}],
    ["stimuli23", "AcceptabilityJudgment", {s: "достанет денег на лечение"}],
