...
var items = [
    ...
    ["stimuli1", "AcceptabilityJudgment", {s: "толпа плывет"}],
    ["stimuli2", "AcceptabilityJudgment", {s: "яблоко падает"}],  
    ["stimuli2", "AcceptabilityJudgment", {s: "чашка падает"}],
    ["stimuli3", "AcceptabilityJudgment", {s: "бросает рюкзак с балкона"}],
    ["stimuli3", "AcceptabilityJudgment", {s: "бросает камень в машину"}],
    ["stimuli4", "AcceptabilityJudgment", {s: "кидает вещ ина стол"}],
    ["stimuli4", "AcceptabilityJudgment", {s: "кидает тень на репутацию"}],
    ["stimuli5", "AcceptabilityJudgment", {s: "река течет"}],
    ["stimuli5", "AcceptabilityJudgment", {s: "поток течет"}],
    ["stimuli6", "AcceptabilityJudgment", {s: "боинг рухнет"}],
    ["stimuli6", "AcceptabilityJudgment", {s: "башня рухнет"}],	
    ["stimuli7", "AcceptabilityJudgment", {s: "планета вращает вокруг солнца"}],
    ["stimuli7", "AcceptabilityJudgment", {s: "разговор вращается вокруг одной темы"}],
    ["stimuli8", "AcceptabilityJudgment", {s: "человек шатается от боли"}],
    ["stimuli8", "AcceptabilityJudgment", {s: "калека шатается на костылях"}],
    ["stimuli9", "AcceptabilityJudgment", {s: "веревка болтатеся на крючке"}],
    ["stimuli9", "AcceptabilityJudgment", {s: "гайка болтается на колесе"}],
    ["stimuli10", "AcceptabilityJudgment", {s: "птенец выпадет из гнезда"}],
    ["stimuli10", "AcceptabilityJudgment", {s: "работник выпадет из рутины"}],
    ["stimuli11", "AcceptabilityJudgment", {s: "пламя колеблется"}],
    ["stimuli11", "AcceptabilityJudgment", {s: "огонь колеблется"}],
    ["stimuli12", "AcceptabilityJudgment", {s: "дитя тянется за пищей"}],
    ["stimuli12", "AcceptabilityJudgment", {s: "гимнаст тянется на шпагат"}],
    ["stimuli13", "AcceptabilityJudgment", {s: "толкает перед собой телегу"}],
    ["stimuli13", "AcceptabilityJudgment", {s: "толкает речь на сцене"}],
    ["stimuli14", "AcceptabilityJudgment", {s: "брелок висит"}],
    ["stimuli14", "AcceptabilityJudgment", {s: "люстра висит"}],
    ["stimuli15", "AcceptabilityJudgment", {s: "змея ползет в траве"}],
    ["stimuli15", "AcceptabilityJudgment", {s: "паук ползет по паутине"}],
    ["stimuli16", "AcceptabilityJudgment", {s: "такси встанет"}],
    ["stimuli16", "AcceptabilityJudgment", {s: "работа встанет"}],
    ["stimuli17", "AcceptabilityJudgment", {s: "ищет работу на сайте"}],
    ["stimuli17", "AcceptabilityJudgment", {s: "ищет учителя в школу"}],
    ["stimuli18", "AcceptabilityJudgment", {s: "найдет ключи в кармане"}],
    ["stimuli18", "AcceptabilityJudgment", {s: "найдет монетку н асфальте"}],
    ["stimuli19", "AcceptabilityJudgment", {s: "кольцо соскочит с пальца"}],
    ["stimuli19", "AcceptabilityJudgment", {s: "фраза соскочит с языка"}],
    ["stimuli20", "AcceptabilityJudgment", {s: "шляпа слетит с головы"}],
    ["stimuli20", "AcceptabilityJudgment", {s: "платок слетит с шеи"}],
    ["stimuli21", "AcceptabilityJudgment", {s: "поставит сковородку на плиту"}],
    ["stimuli21", "AcceptabilityJudgment", {s: "поставит цветы в вазу"}],
    ["stimuli22", "AcceptabilityJudgment", {s: "режет огурцы на доске"}],
    ["stimuli22", "AcceptabilityJudgment", {s: "режет глаз от солнца"}],
    ["stimuli23", "AcceptabilityJudgment", {s: "достанет ручку из сумки"}],
    ["stimuli23", "AcceptabilityJudgment", {s: "достанет книгу с полки"}],
